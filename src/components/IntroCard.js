...
export default function IntroCard({ intro }) {
  ...
  return (
    <Card
      ...
      rowSpan="md:row-span-5 lg:row-span-5"
      height="md:min-h-[360px] lg:min-h-[380px]"
    >
      <div className="flex w-full h-full">
        <div className="flex flex-col justify-between md:max-h-[300px] gap-4">
          <div className="flex flex-col h-full">
            <h6 className="text-sm font-light m-0 text-gray-500">
              {welcomeLabel}
            </h6>
              ...
              >
                <Button aria-label={socialButton.ariaLabel}>
                  ...
                  <span className="sr-only">
                    {socialButton.screenReaderLabel}
                  </span>
                </Button>
              </a>
            ))}
